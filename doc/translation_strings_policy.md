...
This document provides guidelines for internationalization of the Remix Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Remix network</numerusform>
            <numerusform>%n active connections to Remix network</numerusform>
        </translation>
    </message>
