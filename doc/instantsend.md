...
This mechanism has been integrated into Bitcore-Node-Remix which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/remixcoin/insight-api-remix#web-socket-api](https://github.com/remixcoin/insight-api-remix#web-socket-api) 
* API: [https://github.com/remixcoin/insight-api-remix#instantsend-transactions](https://github.com/remixcoin/insight-api-remix#instantsend-transactions) 
...
By default, the Remix Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Remix Core daemon:
