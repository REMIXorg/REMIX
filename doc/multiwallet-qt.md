...
Only requiring some minor changes is remix.cpp.
...
Changes to remix.cpp
----------------------
remix.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
