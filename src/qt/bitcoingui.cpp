    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Remix Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Remix address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and remix: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Remix Core"), this);
    aboutAction->setStatusTip(tr("Show information about Remix Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Remix Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Remix addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Remix addresses"));
    ...
    openAction->setStatusTip(tr("Open a remix: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Remix Core help message to get a list with possible Remix Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Remix Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Remix network", "", count));
}
...
{
    QString strTitle = tr("Remix Core"); // default title
