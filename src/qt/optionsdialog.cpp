    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("REMIX-light"), QVariant("light"));
    ui->theme->addItem(QString("REMIX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("REMIX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("REMIX-traditional"), QVariant("trad"));
