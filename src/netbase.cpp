...
static bool Socks5(const std::string& strDest, int port, const ProxyCremixtials *auth, SOCKET& hSocket)
{
...
static bool ConnectThroughProxy(const proxyType &proxy, const std::string& strDest, int port, SOCKET& hSocketRet, int nTimeout, bool *outProxyConnectionFailed)
{
    ...
    if (proxy.randomize_cremixtials) {
        ProxyCremixtials random_auth;
