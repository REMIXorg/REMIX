...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RemixNetwork") type = RemixNetwork;
    if(strType == "RemixNetworkVariable") type = RemixNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RemixNetwork) s = "RemixNetwork";
    if(type == RemixNetworkVariable) s = "RemixNetworkVariable";
