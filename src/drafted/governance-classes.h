 ...
 *
 *   // network
 *   CRemixNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.remixcoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CRemixNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: RemixNetwork
// //   -- signature requirements : Key1(User)
// class CRemixNetworkVariable : public CGovernanceObject
// {
// private:
