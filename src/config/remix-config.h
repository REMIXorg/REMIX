/* src/config/remix-config.h.  Generated from remix-config.h.in by configure.  */
/* src/config/remix-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef REMIX_CONFIG_H

#define REMIX_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Remix Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Remix Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/Remix/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Remix Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Remix Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "remixcore"
