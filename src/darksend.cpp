...
{
    if(fLiteMode) return; // ignore all Remix related functionality
...
/*
    ...
    allow endless transaction that would bloat Remix and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("remix-privatesend");
