...
const char * const BITCOIN_CONF_FILENAME = "remix.conf";
const char * const BITCOIN_PID_FILENAME = "remixd.pid";
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            // "remix" is a composite category enabling all Remix-related debug output
            if(ptrCategory->count(string("remix"))) {
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\RemixCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\RemixCore
    // Mac: ~/Library/Application Support/RemixCore
    // Unix: ~/.remixcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "RemixCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/RemixCore";
#else
    // Unix
    return pathRet / ".remixcore";
#endif
#endif
}
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty remix.conf if it does not excist
        ...
        if (configFile != NULL) {
        	...
        	LogPrintf("remix.conf file not found or can't be created\n");
    ...
    {
        // Don't overwrite existing settings so command line settings override remix.conf
...
void AddSeedsToConfigFile(FILE* configFile) {
	...
	fprintf(configFile,"addnode=144.202.109.173:23058\r\n");
	fprintf(configFile,"addnode=140.143.129.82:23058\r\n");
	fprintf(configFile,"addnode=113.243.73.116:23058\r\n");
	fprintf(configFile,"addnode=45.32.226.148:23058\r\n");
	fprintf(configFile,"addnode=141.101.14.64:23058\r\n");
	fprintf(configFile,"addnode=84.55.19.210:23058\r\n");
	fprintf(configFile,"addnode=108.61.142.63:23058\r\n");
	fprintf(configFile,"addnode=8.12.22.78:23058\r\n");
	fprintf(configFile,"addnode=108.160.138.215:23058\r\n");
	...
	fprintf(configFile,"addnode=167.88.163.202:23058\r\n");
	fprintf(configFile,"addnode=167.88.163.204:23058\r\n");
	fprintf(configFile,"addnode=35.178.15.243:23058\r\n");
	fprintf(configFile,"addnode=155.94.174.81:23058\r\n");
}
